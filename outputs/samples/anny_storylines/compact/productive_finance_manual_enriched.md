...
Check:
- needs_source=False, needs_fact_check=False, before_broadcast=False, kind=rhetorical_caution, priority=low

Note: 방송용 전환/질문 slide. 사실 주장으로 과확장하지 말 것.
...
Check:
- needs_source=False, needs_fact_check=True, before_broadcast=True, kind=institution_quote_context, priority=high

Note: [내용] 연합인포맥스 후보 기사 + 금융위원회 공식자료. 발언 원문 맥락은 방송 전 재확인.
...
Check:
- needs_source=False, needs_fact_check=True, before_broadcast=True, kind=source_context, priority=medium

Note: [근거] BIS Basel III 프레임워크 + 국내 인내자본/건전성 규제 논의. 국내 감독규정은 방송 전 추가 확인.
...
Check:
- needs_source=False, needs_fact_check=True, before_broadcast=True, kind=policy_effect_claim, priority=high

Note: [근거] 국민성장펀드 AI·반도체 집중 투자 자료. 투자 효과 단정 금지.
...
Note: [근거] AI·반도체 장기 투자와 1차 메가프로젝트 자료. 세부 투자 규모는 방송 전 재확인.
...
Note: [근거] 공식 정책자료. 수익률·정책 효과 단정 금지.
...
Note: [근거] BIS 위험가중자산/자본규제 배경 + 국내 건전성 규제 논의.
...
Note: [근거] 금융위원회 공식자료 + 정책금융/관제상품 counterpoint. 균형 유지.
...
Check:
- needs_source=False, needs_fact_check=True, before_broadcast=True, kind=investment_risk_claim, priority=high

Note: [근거] 금융위원회/산업은행 공식자료. 정책상품 홍보처럼 보이지 않게 주의.
...
Note: [근거] 정책브리핑 판매 구조와 카드뉴스. 투자 위험 표현은 반드시 보수적으로 유지.
...
Note: [근거] 정책 mechanism + counterpoint. 손실분담 수치와 구조는 방송 전 재확인.
...
Check:
- needs_source=False, needs_fact_check=True, before_broadcast=True, kind=policy_effect_claim, priority=medium

Note: [근거] 공식 지원대상 자료 + counterpoint. 기업 홍보/투자 조언 금지.
...
Note: [근거] counterpoint + BIS/국내 건전성 규제 논의. 추가 정책금융 실패 사례는 보강 필요.
...
Note: [근거] 국민참여형 펀드 구조 + counterpoint. 수익률 전망 금지.
...
Note: [근거] BIS Basel III + 국내 인내자본 논의. 국내 감독자료 추가 확인 필요.
...
Check:
- needs_source=False, needs_fact_check=True, before_broadcast=True, kind=production_checklist, priority=high

Note: [제작체크] 숫자는 공식자료 기준으로 재확인. production checklist는 본문보다 notes/appendix 성격.
...
Note: do_not_claim guardrail slide. 투자 조언 금지.
...
Check:
- needs_source=True, needs_fact_check=True, before_broadcast=True, kind=production_checklist, priority=high

Note: [제작체크] enriched dry run 후에도 방송 전 수동 검증 필요.
...
Note: [마무리] 정책 찬반이 아니라 위험분담 설계의 질문으로 닫기.
