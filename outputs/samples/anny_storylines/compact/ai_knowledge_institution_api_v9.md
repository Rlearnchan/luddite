...
Note: 제목 슬라이드. 사실 주장 없음(rhetorical).

### 02. AI 즉답의 편리함 — BBC: 'Instant AI answers can trivialise human intelligence'
...
Note: Primary seed: BBC 기사 인용. 원문 전문 확인 필요(Manual). fact_check_priority=high; single_source_dependency 위험. production 참고용: BBC 본문 전문 확인 필요.
...
Check:
- needs_source=True, needs_fact_check=True

Note: BBC 원문 전문 및 발언 맥락 확인 필요(required_before_storyline). 단일 기사 기반이므로 보조 출처 필요.

## Section 2. 증거와 배경

### 04. 생각하는 과정 — 생성형 AI와 정보 다양성
...
Note: Microsoft 연구를 근거로 '중간 과정(질문·비교·검증)'이 생략될 가능성을 제시. 연구결과의 해석은 보수적으로 다뤄야 함.

### 05. OECD의 관점: GenAI는 튜터·파트너가 될 수 있다
...
Note: OECD 보고서는 정책·교수 설계 관점의 근거로 유용. 구체 사례·숫자 확인은 필요.

### 06. 접근성 — AI가 교육의 접근성과 개인화를 지원할 가능성
...
Note: Counterpoint: 접근성·개인화 가능성은 분명한 반론이다. 방송에서는 균형 있게 제시해야 함.

### 07. UNESCO: 권리와 안전장치가 전제돼야 한다
...
Note: Counterpoint은 핵심: AI의 접근성 이점은 권리·안전 확보와 함께 논의되어야 함.
...
Note: 전환용 브리지. 사실 주장 최소화(rhetorical bridge / no factual claim).

## Section 3. 지식기관의 대응

### 09. 학교 / 박물관 / 천문관 / 지식기관의 역할
...
Note: 발언의 정확한 맥락과 원문 확인 필요(required_before_storyline, required_before_broadcast). single_source_dependency 표시 고려.

### 11. 국립과학관의 AI 전시(국내 사례)
...
Note: 전시 사례는 '체험형 교육'의 한 예시. 전시의 교육 효과를 단정하지 않음.

### 12. 국내 정책: 2025년부터 AI 디지털교과서 도입(정책브리핑)
...
Note: 정책 공지 출처를 제시. 구체 도입 범위·시행계획 등 원문 확인 필요(required_before_broadcast).
...
Note: 기관별 프로그램은 사례 확인 필요. 교육 효과를 단정하지 않음.

### 14. 관측소의 역사 교육 vs AI 즉답의 현재
...
Note: 비교는 개념적 전환을 돕기 위한 슬라이드. 발언 맥락/기관 프로그램은 추가 확인 필요.

### 15. 실무 리스크: 의존·과장·단일출처 의존
...
Note: 방송 전 BBC 원문·Microsoft 연구의 해석·국내 사례 추가 확보 필요. risk_flags에 single_source_dependency 가능성.

## Section 4. 무엇을 가르칠 것인가?

### 16. 무엇을 가르칠 것인가: 질문의 전환
...
Note: 섹션 전환용 질문. 사실 주장 최소화. 방송 전 UNESCO 프레임 검토 권장.

### 17. UNESCO의 AI 역량 프레임(학생용)
...
Note: 교육·역량 주장에 대해서는 보수적으로 다루어야 함. 기관 프레임은 방송 전 추가 검증 필요(required_before_broadcast).

### 18. OECD 권고 요지: 명확한 교수원칙이 성과를 좌우한다
...
Note: OECD 권고를 방송용 요약으로 제시. 구체 권고사항은 원문 참조 필요.

### 19. 실무 제안: 질문하기·검증하기·출처 가르치기
...
Note: 교육적 제안은 프레임을 바탕으로 한 제안적 목록. 교육 효과를 단정하지 않음.

### 20. Counterpoint: 접근성·개인화의 기회도 놓치지 마라
...
Note: 반대 관점(접근성·포용) 포함. 방송에서는 균형 있게 제시.
...
Note: required_before_broadcast 항목 다수 존재함. 이 슬라이드는 제작용 체크리스트이며 방송 전 모두 확인 필요(required_before_broadcast).

_Internal production checklist, not a broadcast claim._

## Section 5. 마무리 & 질문

### 22. 정보 생태계의 변화가 남긴 불확실성
...
Note: 교육 효과·인지 저하를 단정하지 않음. 추가 연구·통계 확인 필요.

### 23. 제작 리스크: 단일 출처 의존 경고
...
Note: single_source_dependency 리스크: 보조 기사 확보 필요.
...
Note: 순수 질문형 클로징. 사실 주장 없음. 방송 토론용 질문으로 사용.
...
Note: 결론은 가이드라인 수준. 방송 전 프레이밍·표현 점검 필요.
