...
- schema_errors: []
- empty_source_errors: ['slide 1 has empty source_urls without needs_source=true', 'slide 3 has empty source_urls without needs_source=true', 'slide 6 has empty source_urls without needs_source=true', 'slide 21 has empty source_urls without needs_source=true']
